 ...
 */
@Service
public class RecuperarListaEstadoSoporteServiceImplementacion implements RecuperarListaEstadoSoporteService{
    @PersistenceContext
    ...
    public List<RecuperarListaEstadoSoporteEntity> ConsultaEstadoSoporte() {
        try {
            StoredProcedureQuery consBpmSoporte = repositorio.createNamedStoredProcedureQuery("RecuperarListaEstadoSoporte");
